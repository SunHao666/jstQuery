 ...
 * 入库信息
 */
public class RKInfoActivity extends BaseActivity implements ViewPager.OnPageChangeListener{
    ...
    public int getLayout() {
        return R.layout.activity_rkinfo;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.home_bottom:
                startActivity(new Intent(RKInfoActivity.this, MainActivity.class));
                finish();
                break;
            case R.id.vp_left:
                ...
                .enqueue(new BaseCallback<RKBean>() {
                    ...
                    protected void onSuccess(RKBean bean) {
                        ...
                        for (int i = 0; i < bean.getTotalPage(); i++) {
                            //修改Fragment
                            data.add(new RKFragment(i + 1, map));
                        }
                    ...
                    protected void onFailed(int code, String msg) {
                        Toast.makeText(RKInfoActivity.this, msg, Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
